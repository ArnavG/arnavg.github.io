...
So I think generally having some basic computational competency goes a long way as a data scientist or data engineer. I've already discussed DSA and databases, but if you can find any courses on computer architecture, distributed learning, or networking, I'd recommend taking at least one of them.
