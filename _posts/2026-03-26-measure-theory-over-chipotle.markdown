...
Early last week, my friends and I convened at the Foster City Chipotle for another evening classic of bowls and banter. During one of our very enlightened and philosophical conversations – concerning how tall people are, if we assume height is a continuous distribution – one of my friends asked if the average male height being 5'9 means someone in the population has to be exactly 5'9.[^1]
...
The answer is obviously no, and we can come up with some very simple counterexamples to show why this isn't true. In a population of two people with heights of 5'8 and 5'10, the mean and median height is 5'9, yet neither person in the population is 5'9. Now, it's not a realistic counterexample, since (1) we talk about height in discretized terms anyway rather than continuous, and (2) we know many people to be approximately 5'9 in the population. But still, it's a valid counterexample. QED.

A more interesting question, however, that one of my friends even momentarily alluded to, is that if someone having any given exact, granular height drawn from the continuous distribution occurs with probability 0, then how can it also be true that someone in the population has that height?
...
For continuous distributions, however, such as our motivating example of height from the intro, counting no longer makes sense. If our sample space is the real line, or some interval of it, then even a tiny interval contains infinitely many points.
...
Let's revisit the height example. The event that a randomly drawn individual has an exact height of 5'9 (or 69.000000.. inches) has probability 0, so it occurs *almost never*. Does that mean there exists no one in the population with a height of 69 inches exactly, or that it is impossible to have a height of 69 inches? No! The way we construct probability when talking about events drawn from a continuous distribution of outcomes is fundamentally reliant on taking probabilities over intervals of outcomes; the probability of a single point is 0 because it has no length (Lebesgue measure $$0$$). Think of it this way: you currently exist with some height, so clearly, it is *possible* to attain such a height; however, the probability of that single, exact score being drawn from the height distribution is 0.

So what *is* an impossible event? Well, in principle, height is lower bounded at 0 inches; there certainly can't be someone with negative height. The shortest person ever was recorded at <a href="https://en.wikipedia.org/wiki/List_of_the_verified_shortest_people">21.5 inches</a>, while the tallest person ever recorded was <a href="https://en.wikipedia.org/wiki/List_of_tallest_people">107 inches</a>, or 8'11. If height is modeled as a continuous distribution lower bounded by 0 inches (I'm hesitant to place an upper bound...), then values outside this range, called the *support* of the distribution, are what we would describe as "impossible." So while the probability of having a height of 69.0000... inches is 0 but still possible (it occurs almost never), it is *impossible* to have a height of -11 inches, since that value lies outside the support of the distribution.
...
At the end of the day, I can at least attest that measure theory is useful for thinking about height at Chipotle with my friends.

---
#### Footnotes
[^1]: <small>Incidentally, this friend is approximately the average male height in the US and is also a former Division 1 basketball player. (I'm of the opinion his <a href="https://queensathletics.com/sports/mens-basketball/roster/aneek-patil/11736">listed height</a> bumps him up an inch or two.) </small>
