...
One problem with <a href="https://www.evidentlyai.com/llm-guide/llm-benchmarks">currently-existing LLM benchmarks</a> is that since LLMs are essentially trained on every last nook and cranny of the Internet, their performance on common benchmarks may reflect memorizing training data – including the benchmark questions themselves – rather than reflect true, out-of-sample reasoning, intelligence, and extrapolation. Recently, Meta wound up in <a href="https://www.zdnet.com/article/metas-llama-4-herd-controversy-and-ai-contamination-explained/">controversy over data contamination</a> in their Llama 4 release. The model crushed benchmarks but performed poorly in production and on other more general tasks outside its specialized benchmarks, suggesting some amount of training data memorization for benchmark questions.
