...
Let's say that 40% of voters support Green as their first choice while 40% of voters support Omar as their first choice. That leaves the remaining 20% who would prefer neither Greene nor Omar - Manchin voters in this hypothetical. Additionally, let's that all Greene voters prefer Manchin to Omar and all Omar voters prefer Manchin to Greene.
...
[^5]: <small> Tangential, but a common mistake I see among leftist voters is conflating their own preferred set of policy preferences from progressive candidates with those policy preferences with being "good" or "correct," with little regard for the actual budgetary or economic impacts of said policies (e.g., progressives want to raise the minimum wage, because they assume that policy brings higher wages to the working class, and so <a href="https://www.cityandstateny.com/policy/2025/02/mamdani-unveils-30-30-minimum-wage-push-part-mayoral-campaign/403015/">Zohran's plan to raise the minimum wage to $30/hr</a> is "good" and makes him the "objectively good" candidate, all while disregarding the actual effects of the policy on things like employment or prices).</small>
